...
dellemc.objectscale.storage_pool_info module -- Gather storage pool information from Dell ObjectScale
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
To use it in a playbook, specify: ``dellemc.objectscale.storage_pool_info``.
...
- Supports listing all storage pools, listing by VDC, fetching by storage pool ID, and filtering by name.
...
.. raw:: html
  ...
  <tr>
    <td valign="top">
      ...
      <p style="display: inline;"><strong>storage_pool_id</strong></p>
  ...
  <tr>
    ...
    <td valign="top">
      <p>Timeout in seconds for API requests.</p>
  ...
  <tr>
    <td valign="top">
      <div class="ansibleOptionAnchor" id="parameter-vdc_id"></div>
      <p style="display: inline;"><strong>vdc_id</strong></p>
      <a class="ansibleOptionLink" href="#parameter-vdc_id" title="Permalink to this option"></a>
      <p style="font-size: small; margin-bottom: 0;">
        <span style="color: purple;">string</span>
      </p>
    </td>
...
.. raw:: html
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <p style="display: inline;"><strong>storage_pools</strong></p>
    ...
    <td valign="top">
      <p>List of storage pools matching query criteria.</p>
      <p style="margin-top: 8px;"><b>Returned:</b> always</p>
      <p style="margin-top: 8px; color: blue; word-wrap: break-word; word-break: break-all;"><b style="color: black;">Sample:</b> <code>[{&#34;name&#34;: &#34;sp_ansible&#34;, &#34;id&#34;: &#34;urn:storageos:VirtualArray:xxxx&#34;}]</code></p>
    </td>
  </tr>
