...
Modules for Dell Technologies (Dell) ObjectScale.
...
||----------|--------------|-----------------------------------------------------------|
|| 01       | June 2026 | Ansible Modules for Dell ObjectScale 1.0.0 |
...
---------------------------
This section describes the features or enhancements of the Ansible Modules for Dell ObjectScale for this release.
...
for ObjectScale GitHub](https://github.com/dell/ansible-objectscale/tree/main) page.

Documentation
-------------
The documentation is available on [Ansible Modules for ObjectScale GitHub](https://github.com/dell/ansible-objectscale/tree/main/docs)
