...
class BucketServiceGetBucketLockResponse(BaseModel):
    """BucketServiceGetBucketLockResponse"""
    bucket_name: Optional[StrictStr] = Field(default=None, description="Bucket name to be locked.")
    is_locked: Optional[StrictBool] = Field(default=None, description="Set to \"true\" for lock bucket and \"false\" for unlock bucket.", alias="isLocked")
