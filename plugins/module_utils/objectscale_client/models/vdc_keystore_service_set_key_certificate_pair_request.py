...
class VdcKeystoreServiceSetKeyCertificatePairRequest(BaseModel):
    """Request payload for PUT /vdc/keystore — rotate_keycertchain."""
    key_and_certificate: VdcKeystoreServiceSetKeyCertificatePairRequestKeyAndCertificate = Field(
        description="Key and certificate pair to set on the VDC keystore.")
