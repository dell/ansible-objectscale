...
class IamServiceListPolicyVersionsResponse(BaseModel):
    """IamServiceListPolicyVersionsResponse"""
    list_policy_versions_result: Optional[IamServiceListPolicyVersionsResponseListPolicyVersionsResult] = Field(default=None, alias="ListPolicyVersionsResult")
