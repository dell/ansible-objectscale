...
class IamServiceCreateAccessKeyResponseCreateAccessKeyResult(BaseModel):
    """IamServiceCreateAccessKeyResponseCreateAccessKeyResult"""
    access_key: Optional[IamServiceCreateAccessKeyResponseCreateAccessKeyResultAccessKey] = Field(default=None, alias="AccessKey")
