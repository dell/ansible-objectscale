...
class IamServiceGetPolicyVersionResponse(BaseModel):
    """IamServiceGetPolicyVersionResponse"""
    get_policy_version_result: Optional[IamServiceGetPolicyVersionResponseGetPolicyVersionResult] = Field(default=None, alias="GetPolicyVersionResult")
