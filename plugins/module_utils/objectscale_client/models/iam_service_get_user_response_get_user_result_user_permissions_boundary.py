...
class IamServiceGetUserResponseGetUserResultUserPermissionsBoundary(BaseModel):
    """IamServiceGetUserResponseGetUserResultUserPermissionsBoundary"""
    permissions_boundary_arn: Optional[StrictStr] = Field(default=None, alias="PermissionsBoundaryArn")
    permissions_boundary_type: Optional[StrictStr] = Field(default=None, alias="PermissionsBoundaryType")
