...
class IamServiceCreateAccessKeyResponse(BaseModel):
    """IamServiceCreateAccessKeyResponse"""
    create_access_key_result: Optional[IamServiceCreateAccessKeyResponseCreateAccessKeyResult] = Field(default=None, alias="CreateAccessKeyResult")
