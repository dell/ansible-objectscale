...
class MgmtUserInfoServiceGetLocalUserInfosResponse(BaseModel):
    """MgmtUserInfoServiceGetLocalUserInfosResponse"""
    mgmt_user_info: Optional[List[MgmtUserInfoServiceGetLocalUserInfosResponseMgmtUserInfoInner]
                             ] = Field(default=None, description="List of management user infos")
