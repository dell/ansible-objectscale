...
class BucketServiceSetBucketHeadMetadataRequestMetadataInner(BaseModel):
    """BucketServiceSetBucketHeadMetadataRequestMetadataInner"""
    name: StrictStr = Field(description="Name of the metadata entry")
    value: StrictStr = Field(description="Value of the metadata entry")
