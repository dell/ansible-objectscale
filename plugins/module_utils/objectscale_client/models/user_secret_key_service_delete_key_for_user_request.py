...
class UserSecretKeyServiceDeleteKeyForUserRequest(BaseModel):
    """UserSecretKeyServiceDeleteKeyForUserRequest"""
    secret_key: Optional[StrictStr] = Field(default=None, description="Identity of the secret key")
    namespace: Optional[StrictStr] = Field(default=None, description="User qualifier if the User Scope is NAMESPACE")
    secret_key_id: Optional[StrictStr] = Field(default=None, description="SHA-256 hash for Secret key to be deleted")
