...
class ObjectVarrayServiceGetVirtualArraysResponse(BaseModel):
    """ObjectVarrayServiceGetVirtualArraysResponse"""
    varray: Optional[List[ObjectVarrayServiceGetVirtualArraysResponseVarrayInner]] = Field(default=None, description="List of storage pools")
