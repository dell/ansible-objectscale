...
class IamServiceCreateUserResponseCreateUserResult(BaseModel):
    """Wrapper with details about the new IAM user."""
    user: Optional[IamServiceCreateUserResponseCreateUserResultUser] = Field(default=None, alias="User")
