...
class IamServiceGetUserPolicyResponse(BaseModel):
    """IamServiceGetUserPolicyResponse"""
    get_user_policy_result: Optional[IamServiceGetUserPolicyResponseGetUserPolicyResult] = Field(default=None, alias="GetUserPolicyResult")
