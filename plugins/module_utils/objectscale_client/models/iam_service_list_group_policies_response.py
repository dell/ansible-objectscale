...
class IamServiceListGroupPoliciesResponse(BaseModel):
    """IamServiceListGroupPoliciesResponse"""
    list_group_policies_result: Optional[IamServiceListGroupPoliciesResponseListGroupPoliciesResult] = Field(default=None, alias="ListGroupPoliciesResult")
