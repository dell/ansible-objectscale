...
class IamServiceGetPolicyResponse(BaseModel):
    """IamServiceGetPolicyResponse"""
    get_policy_result: Optional[IamServiceGetPolicyResponseGetPolicyResult] = Field(default=None, alias="GetPolicyResult")
