...
class ObjectCertificateServiceGetCertificateChainResponseCertificateChain(BaseModel):
    """Inner certificate_chain object returned by GET /object-cert/keystore."""
