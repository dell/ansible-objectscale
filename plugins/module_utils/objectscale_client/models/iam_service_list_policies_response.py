...
class IamServiceListPoliciesResponse(BaseModel):
    """IamServiceListPoliciesResponse"""
    list_policies_result: Optional[IamServiceListPoliciesResponseListPoliciesResult] = Field(default=None, alias="ListPoliciesResult")
