...
class IamServiceCreatePolicyResponse(BaseModel):
    """IamServiceCreatePolicyResponse"""
    create_policy_result: Optional[IamServiceCreatePolicyResponseCreatePolicyResult] = Field(default=None, alias="CreatePolicyResult")
