...
class IamServiceListUserPoliciesResponse(BaseModel):
    """IamServiceListUserPoliciesResponse"""
    list_user_policies_result: Optional[IamServiceListGroupPoliciesResponseListGroupPoliciesResult] = Field(default=None, alias="ListUserPoliciesResult")
