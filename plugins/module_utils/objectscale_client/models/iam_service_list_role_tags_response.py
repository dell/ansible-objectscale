...
class IamServiceListRoleTagsResponse(BaseModel):
    """IamServiceListRoleTagsResponse"""
    list_role_tags_result: Optional[IamServiceListAttachedGroupPoliciesResponseListAttachedGroupPoliciesResult] = Field(
        default=None, alias="ListRoleTagsResult")
