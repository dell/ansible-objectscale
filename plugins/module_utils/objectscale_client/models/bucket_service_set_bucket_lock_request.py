...
class BucketServiceSetBucketLockRequest(BaseModel):
    """BucketServiceSetBucketLockRequest"""
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace that is allowed to access this bucket")
