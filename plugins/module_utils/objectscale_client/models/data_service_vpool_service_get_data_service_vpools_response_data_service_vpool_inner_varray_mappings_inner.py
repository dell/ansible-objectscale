...
class DataServiceVpoolServiceGetDataServiceVpoolsResponseDataServiceVpoolInnerVarrayMappingsInner(BaseModel):
    """DataServiceVpoolServiceGetDataServiceVpoolsResponseDataServiceVpoolInnerVarrayMappingsInner"""
    name: Optional[StrictStr] = Field(default=None, description="Virtual data center id")
    value: Optional[StrictStr] = Field(default=None, description="Storage pool id")
    is_replication_target: Optional[StrictBool] = Field(default=None, description="is replication target")
