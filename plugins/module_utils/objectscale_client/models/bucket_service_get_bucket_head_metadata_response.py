...
class BucketServiceGetBucketHeadMetadataResponse(BaseModel):
    """BucketServiceGetBucketHeadMetadataResponse"""
    head_type: Optional[StrictStr] = None
    metadata: Optional[List[BucketServiceSetBucketHeadMetadataRequestMetadataInner]] = None
