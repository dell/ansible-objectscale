...
class UserManagementServiceRemoveUserRequest(BaseModel):
    """UserManagementServiceRemoveUserRequest"""
    user: StrictStr = Field(description="User to be deleted")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace identifier to associate with the user")
