...
class IamServiceListRolePoliciesResponse(BaseModel):
    """IamServiceListRolePoliciesResponse"""
    list_role_policies_result: Optional[IamServiceListGroupPoliciesResponseListGroupPoliciesResult] = Field(default=None, alias="ListRolePoliciesResult")
