...
class NamespaceServiceCreateRetentionClassRequest(BaseModel):  # type: ignore[reportGeneralTypeIssues]
    ...
    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional["NamespaceServiceCreateRetentionClassRequest"]:
        if obj is None:
            return None
