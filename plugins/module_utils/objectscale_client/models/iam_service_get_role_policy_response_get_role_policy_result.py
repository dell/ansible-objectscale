...
class IamServiceGetRolePolicyResponseGetRolePolicyResult(BaseModel):
    ...
    policy_name: Optional[StrictStr] = Field(default=None, description="Simple name identifying the policy.", alias="PolicyName")
    policy_document: Optional[StrictStr] = Field(default=None, description="The policy Document.", alias="PolicyDocument")
