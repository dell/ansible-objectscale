...
from ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client.models.object_certificate_service_get_certificate_chain_response_certificate_chain import (  # noqa: E501
    ObjectCertificateServiceGetCertificateChainResponseCertificateChain,
)
try:
...
class ObjectCertificateServiceGetCertificateChainResponse(BaseModel):
    """Response from GET /object-cert/keystore — contains the current object-cert certificate chain."""
    certificate_chain: Optional[ObjectCertificateServiceGetCertificateChainResponseCertificateChain] = Field(
        default=None,
        description="Certificate chain wrapper object")
