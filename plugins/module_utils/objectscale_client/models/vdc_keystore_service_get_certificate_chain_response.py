...
from ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client.models.vdc_keystore_service_get_certificate_chain_response_certificate_chain import (  # noqa: E501
    VdcKeystoreServiceGetCertificateChainResponseCertificateChain,
)
try:
...
class VdcKeystoreServiceGetCertificateChainResponse(BaseModel):
    """Response from GET /vdc/keystore — contains the current VDC certificate chain."""
    certificate_chain: Optional[VdcKeystoreServiceGetCertificateChainResponseCertificateChain] = Field(
        default=None,
