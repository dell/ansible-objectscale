...
class ObjectVarrayServiceUpdateVirtualArrayRequest(BaseModel):
    """ObjectVarrayServiceUpdateVirtualArrayRequest"""
    name: StrictStr = Field(description="Name of virtual array to be updated")
    is_protected: StrictBool = Field(description="Set true if varray is protected, false otherwise", alias="isProtected")
    description: Optional[StrictStr] = Field(default=None, description="Description. If no description found, then \"Virtual Array\" is used by default")
    is_cold_storage_enabled: Optional[StrictBool] = Field(default=None, description="Is ColdStorage enabled on the virtual array", alias="isColdStorageEnabled")
    ...
    number_of_data_blocks: Optional[StrictInt] = Field(default=None, description="Number of data blocks for configurable EC scheme", alias="numberOfDataBlocks")
    number_of_code_blocks: Optional[StrictInt] = Field(default=None, description="Number of code blocks for configurable EC scheme", alias="numberOfCodeBlocks")
    number_of_storage_server_instances: Optional[StrictInt] = Field(
        default=None,
        description="Number of storage server instances for validation of configurable EC scheme",
        alias="numberOfStorageServerInstances")
