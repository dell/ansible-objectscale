...
class IamServiceCreateGroupResponse(BaseModel):
    """IamServiceCreateGroupResponse"""
    create_group_result: Optional[IamServiceCreateGroupResponseCreateGroupResult] = Field(default=None, alias="CreateGroupResult")
