...
class IamServiceGetGroupPolicyResponseGetGroupPolicyResult(BaseModel):
    """IamServiceGetGroupPolicyResponseGetGroupPolicyResult"""
    group_name: Optional[StrictStr] = Field(default=None, description="Friendly name of the group.", alias="GroupName")
