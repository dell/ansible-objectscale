...
class BucketServicePutBucketDefaultLockConfigurationRequestRule(BaseModel):
    """The Object Lock rule in place for the specified bucket."""
    default_retention: Optional[BucketServicePutBucketDefaultLockConfigurationRequestRuleDefaultRetention] = Field(default=None, alias="DefaultRetention")
