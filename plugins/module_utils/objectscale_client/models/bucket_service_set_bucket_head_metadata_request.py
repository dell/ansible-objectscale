...
class BucketServiceSetBucketHeadMetadataRequest(BaseModel):
    """BucketServiceSetBucketHeadMetadataRequest"""
    head_type: Optional[StrictStr] = Field(default=None,
                                           description="The head-type of the bucket metadata (S3, SWIFT, ATMOS, HDFS, CAS, NFS, INTERNAL, DT_QUERY)")
    metadata: Optional[List[BucketServiceSetBucketHeadMetadataRequestMetadataInner]] = Field(default=None, description="Bucket Head Metadata entry")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace of the bucket")
