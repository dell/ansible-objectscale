...
class BucketServiceSetBucketACLRequestAclCustomgroupAclInner(BaseModel):
    """BucketServiceSetBucketACLRequestAclCustomgroupAclInner"""
    customgroup: Optional[StrictStr] = Field(default=None, description="Custom group name")
    permission: Optional[List[StrictStr]] = Field(default=None, description="List of custom group permissions")
