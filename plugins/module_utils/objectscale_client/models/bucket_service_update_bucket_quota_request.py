...
class BucketServiceUpdateBucketQuotaRequest(BaseModel):
    ...
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace to which this bucket belongs")
