...
class BucketServiceGetBucketsResponse(BaseModel):
    """BucketServiceGetBucketsResponse"""
    object_bucket: List[BucketServiceGetBucketsResponseObjectBucketInner] = Field(description="A list of buckets")
    max_buckets: Optional[StrictInt] = Field(default=None, description="Number of buckets requested.", alias="MaxBuckets")
