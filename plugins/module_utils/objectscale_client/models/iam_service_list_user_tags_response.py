...
class IamServiceListUserTagsResponse(BaseModel):
    """IamServiceListUserTagsResponse"""
    list_user_tags_result: Optional[IamServiceListAttachedGroupPoliciesResponseListAttachedGroupPoliciesResult] = Field(
        default=None, alias="ListUserTagsResult")
