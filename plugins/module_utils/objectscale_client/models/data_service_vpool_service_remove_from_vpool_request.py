...
class DataServiceVpoolServiceRemoveFromVpoolRequest(BaseModel):
    """DataServiceVpoolServiceRemoveFromVpoolRequest"""
    mappings: List[DataServiceVpoolServiceGetDataServiceVpoolsResponseDataServiceVpoolInnerVarrayMappingsInner]
