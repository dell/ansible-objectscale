...
class IamServiceListAttachedRolePoliciesResponse(BaseModel):
    """IamServiceListAttachedRolePoliciesResponse"""
    list_attached_role_policies_result: Optional[IamServiceListAttachedGroupPoliciesResponseListAttachedGroupPoliciesResult] = Field(
        default=None, alias="ListAttachedRolePoliciesResult")
