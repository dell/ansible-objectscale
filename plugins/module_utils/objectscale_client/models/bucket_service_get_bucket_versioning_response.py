...
class BucketServiceGetBucketVersioningResponse(BaseModel):
    """BucketServiceGetBucketVersioningResponse"""
    status: Optional[StrictStr] = Field(default=None, description="Versioning state of the bucket", alias="Status")
