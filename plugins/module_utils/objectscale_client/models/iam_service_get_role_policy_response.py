...
class IamServiceGetRolePolicyResponse(BaseModel):
    """IamServiceGetRolePolicyResponse"""
    get_role_policy_result: Optional[IamServiceGetRolePolicyResponseGetRolePolicyResult] = Field(default=None, alias="GetRolePolicyResult")
