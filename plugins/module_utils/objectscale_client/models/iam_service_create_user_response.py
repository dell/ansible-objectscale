...
class IamServiceCreateUserResponse(BaseModel):
    """IamServiceCreateUserResponse"""
    create_user_result: Optional[IamServiceCreateUserResponseCreateUserResult] = Field(default=None, alias="CreateUserResult")
