...
class UserManagementServiceSetUserLockRequest(BaseModel):
    """UserManagementServiceSetUserLockRequest"""
    user: StrictStr = Field(description="User name to be locked/unlocked")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace for this user")
    is_locked: StrictBool = Field(description="Set true if user needs to be is to be locked, false otherwise.", alias="isLocked")
