...
class NamespaceServiceGetNamespacesResponseNamespaceInnerUserMappingInnerAttributeInner(BaseModel):  # type: ignore[reportGeneralTypeIssues]
    ...
    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional["NamespaceServiceGetNamespacesResponseNamespaceInnerUserMappingInnerAttributeInner"]:
        if obj is None:
            return None
