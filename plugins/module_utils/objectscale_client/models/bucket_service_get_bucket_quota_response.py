...
class BucketServiceGetBucketQuotaResponse(BaseModel):
    """BucketServiceGetBucketQuotaResponse"""
    bucketname: Optional[StrictStr] = Field(default=None, description="Bucket name")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace name")
    block_size: Optional[StrictInt] = Field(default=None, description="Block size in GB. -1 indicates quota value not defined.", alias="blockSize")
    notification_size: Optional[StrictInt] = Field(
        default=None,
        description="Notification size in GB. -1 indicates quota value not defined.",
