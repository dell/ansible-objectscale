...
class BucketServiceUpdateBucketOwnerRequest(BaseModel):
    """BucketServiceUpdateBucketOwnerRequest"""
    namespace: StrictStr = Field(description="Namespace that is allowed to access this bucket")
    new_owner: StrictStr = Field(description="New owner of the bucket")
    reset_previous_owners: Optional[StrictBool] = Field(default=None, description="flag indicating if previous bucket owner list is to be reset")
