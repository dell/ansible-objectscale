...
class UserManagementServiceGetAllUsersResponseBlobuserInner(BaseModel):
    """UserManagementServiceGetAllUsersResponseBlobuserInner"""
    userid: StrictStr = Field(description="Userid of the user")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace associated with the corresponding user")
