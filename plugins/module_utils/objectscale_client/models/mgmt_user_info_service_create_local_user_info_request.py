...
class MgmtUserInfoServiceCreateLocalUserInfoRequest(BaseModel):
    """MgmtUserInfoServiceCreateLocalUserInfoRequest"""
    user_id: StrictStr = Field(description="Management user id", alias="userId")
    password: Optional[StrictStr] = Field(default=None, description="Password for the management user")
    is_system_admin: Optional[StrictBool] = Field(
        default=None,
        description="If set to true, assigns the  management user to the System Admin role",
        alias="isSystemAdmin")
    is_system_monitor: Optional[StrictBool] = Field(
        default=None,
        description="If set to true, assigns the management user to the System Monitor role",
        alias="isSystemMonitor")
    is_security_admin: Optional[StrictBool] = Field(
        default=None,
        description="If set to true, assigns the management user to the Security Admin role",
