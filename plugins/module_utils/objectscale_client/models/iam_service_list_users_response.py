...
class IamServiceListUsersResponse(BaseModel):
    """IamServiceListUsersResponse"""
    list_users_result: Optional[IamServiceListUsersResponseListUsersResult] = Field(default=None, alias="ListUsersResult")
