...
class IamServiceListAttachedGroupPoliciesResponse(BaseModel):
    """IamServiceListAttachedGroupPoliciesResponse"""
    list_attached_group_policies_result: Optional[IamServiceListAttachedGroupPoliciesResponseListAttachedGroupPoliciesResult] = Field(
        default=None, alias="ListAttachedGroupPoliciesResult")
