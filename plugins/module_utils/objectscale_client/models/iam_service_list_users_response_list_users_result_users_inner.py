...
class IamServiceListUsersResponseListUsersResultUsersInner(BaseModel):
    """IamServiceListUsersResponseListUsersResultUsersInner"""
    arn: Optional[StrictStr] = Field(default=None, description="The ARN of the user", alias="Arn")
    create_date: Optional[StrictStr] = Field(default=None, description="User creation timestamp", alias="CreateDate")
    path: Optional[StrictStr] = Field(default=None, description="The path to the user", alias="Path")
    user_id: Optional[StrictStr] = Field(default=None, description="Unique user ID", alias="UserId")
