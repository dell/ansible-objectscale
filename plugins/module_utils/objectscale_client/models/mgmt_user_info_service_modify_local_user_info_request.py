...
class MgmtUserInfoServiceModifyLocalUserInfoRequest(BaseModel):
    ...
    is_system_admin: Optional[StrictBool] = Field(
        default=None,
        description="Assigns or removes management user to /from System Admin role.",
        alias="isSystemAdmin")
    is_system_monitor: Optional[StrictBool] = Field(
        default=None,
        description="Assigns or removes management user to /from System Monitor role.",
        alias="isSystemMonitor")
    is_security_admin: Optional[StrictBool] = Field(
        default=None,
        description="Assigns or removes management user to/from Security Admin role.",
