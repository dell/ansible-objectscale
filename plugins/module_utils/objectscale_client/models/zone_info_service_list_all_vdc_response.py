...
class ZoneInfoServiceListAllVdcResponse(BaseModel):
    """ZoneInfoServiceListAllVdcResponse"""
    vdc: Optional[List[ZoneInfoServiceListAllVdcResponseVdcInner]] = Field(default=None, description="A list of vdc")
