...
class IamServiceCreateGroupResponseCreateGroupResultGroup(BaseModel):
    """IamServiceCreateGroupResponseCreateGroupResultGroup"""
    group_name: Optional[StrictStr] = Field(default=None, description="Simple name identifying the Group.", alias="GroupName")
    arn: Optional[StrictStr] = Field(default=None, description="Arn that identifies the Group.", alias="Arn")
    group_id: Optional[StrictStr] = Field(default=None, description="Unique Id associated with the Group.", alias="GroupId")
    path: Optional[StrictStr] = Field(default=None, description="The path to the IAM Group.", alias="Path")
    create_date: Optional[StrictStr] = Field(default=None, description="ISO 8601 format DateTime when group was created.", alias="CreateDate")
