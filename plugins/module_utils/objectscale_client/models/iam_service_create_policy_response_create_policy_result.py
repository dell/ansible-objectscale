...
class IamServiceCreatePolicyResponseCreatePolicyResult(BaseModel):
    """Get createPolicyResult"""
    policy: Optional[IamServiceCreatePolicyResponseCreatePolicyResultPolicy] = Field(default=None, alias="Policy")
