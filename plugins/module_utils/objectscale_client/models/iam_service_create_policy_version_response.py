...
class IamServiceCreatePolicyVersionResponse(BaseModel):
    """IamServiceCreatePolicyVersionResponse"""
    create_policy_version_result: Optional[IamServiceCreatePolicyVersionResponseCreatePolicyVersionResult] = Field(
        default=None, alias="CreatePolicyVersionResult")
