...
class BucketServiceGetBucketACLResponse(BaseModel):
    """BucketServiceGetBucketACLResponse"""
    bucket: Optional[StrictStr] = Field(default=None, description="Bucket name")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace name")
    acl: Optional[BucketServiceSetBucketACLRequestAcl] = None
    permission: Optional[List[StrictStr]] = Field(default=None, description="Get short permission list for non namespace owner")
