...
class BucketServiceUpdateBucketIsStaleAllowedRequest(BaseModel):
    """BucketServiceUpdateBucketIsStaleAllowedRequest"""
    is_stale_allowed: StrictStr = Field(description="isStaleAllowed flag of the bucket")
    is_tso_read_only: Optional[StrictBool] = None
