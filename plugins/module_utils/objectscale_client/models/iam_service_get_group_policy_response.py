...
class IamServiceGetGroupPolicyResponse(BaseModel):
    """IamServiceGetGroupPolicyResponse"""
    get_group_policy_result: Optional[IamServiceGetGroupPolicyResponseGetGroupPolicyResult] = Field(default=None, alias="GetGroupPolicyResult")
