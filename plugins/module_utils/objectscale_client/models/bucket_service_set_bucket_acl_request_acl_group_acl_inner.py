...
class BucketServiceSetBucketACLRequestAclGroupAclInner(BaseModel):
    """BucketServiceSetBucketACLRequestAclGroupAclInner"""
    group: Optional[StrictStr] = Field(default=None, description="Group name")
    permission: Optional[List[StrictStr]] = Field(default=None, description="List of group permissions")
