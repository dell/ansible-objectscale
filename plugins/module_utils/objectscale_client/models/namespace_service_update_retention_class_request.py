...
class NamespaceServiceUpdateRetentionClassRequest(BaseModel):  # type: ignore[reportGeneralTypeIssues]
    """NamespaceServiceUpdateRetentionClassRequest"""
    period: Optional[StrictInt] = Field(default=None, description="A new period value for class in seconds")
    ...
    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional["NamespaceServiceUpdateRetentionClassRequest"]:
        if obj is None:
            return None
