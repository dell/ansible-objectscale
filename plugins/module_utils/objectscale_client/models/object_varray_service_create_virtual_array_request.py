...
class ObjectVarrayServiceCreateVirtualArrayRequest(BaseModel):
    """ObjectVarrayServiceCreateVirtualArrayRequest"""
    name: StrictStr = Field(description="Virtual array name")
    is_protected: StrictBool = Field(description="Only false is valid. Protected varray is not supported.", alias="isProtected")
    ...
    drive_technology: Optional[StrictStr] = Field(default=None, description="Drive Technology of VArray", alias="driveTechnology")
