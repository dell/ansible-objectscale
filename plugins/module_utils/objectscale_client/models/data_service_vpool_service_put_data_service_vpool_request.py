...
class DataServiceVpoolServicePutDataServiceVpoolRequest(BaseModel):
    """DataServiceVpoolServicePutDataServiceVpoolRequest"""
    name: StrictStr = Field(description="New name fro the replication group")
    description: Optional[StrictStr] = Field(default=None, description="New description for the replication group")
    enable_rebalancing: Optional[StrictBool] = Field(default=None, description="set if geo rebalancing is enabled")
    allow_all_namespaces: Optional[StrictBool] = Field(default=None, description="AllowAllNamespaces to update", alias="allowAllNamespaces")
