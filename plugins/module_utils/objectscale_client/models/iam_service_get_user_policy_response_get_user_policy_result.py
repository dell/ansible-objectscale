...
class IamServiceGetUserPolicyResponseGetUserPolicyResult(BaseModel):
    """IamServiceGetUserPolicyResponseGetUserPolicyResult"""
    user_name: Optional[StrictStr] = Field(default=None, description="Friendly name of the user.", alias="UserName")
