...
class IamServiceListGroupsResponse(BaseModel):
    """IamServiceListGroupsResponse"""
    list_groups_result: Optional[IamServiceListGroupsResponseListGroupsResult] = Field(default=None, alias="ListGroupsResult")
