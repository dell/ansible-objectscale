...
class BucketServiceGetBucketRetentionResponse(BaseModel):
    """BucketServiceGetBucketRetentionResponse"""
    period: Optional[StrictInt] = Field(default=None, description="Default retention period for bucket in seconds")
