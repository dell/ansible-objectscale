...
class IamServiceListAccessKeysResponse(BaseModel):
    """IamServiceListAccessKeysResponse"""
    list_access_keys_result: Optional[IamServiceListAccessKeysResponseListAccessKeysResult] = Field(default=None, alias="ListAccessKeysResult")
