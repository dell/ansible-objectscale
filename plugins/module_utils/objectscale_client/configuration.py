...
try:
    ...
    try:
        ...
        from ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client._stubs import NotRequired  # stub  # type: ignore

try:
    import urllib3
    import urllib3.util
except ImportError:
    from ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client._stubs import urllib3_stub as urllib3  # stub  # type: ignore
...
conf = ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client.Configuration(
...
conf = ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://objectscale.local:4443" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ansible_collections.dellemc.objectscale.plugins.module_utils.objectscale_client")
    ...
    def logger_file(self, value: Optional[str]) -> None:
        ...
        if self.__logger_file:
            ...
            for _unused, logger in self.logger.items():
        ...
        return [
            {
                ...
                'variables': {
                    'host': {
                        ...
                        'default_value': "objectscale.local",
                        'enum_values': [],
                    }
                }
            }
